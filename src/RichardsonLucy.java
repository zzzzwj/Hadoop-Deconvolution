...
public class RichardsonLucy {
    ...
    public double[] run(double[] img, int n, Complex[] h, int max_iter) {
        N = n;
        ...
        Complex[] dft_h = fft.transform(h, TransformType.FORWARD);
    ...
    private void real2complex(Complex[] dst, double[] src) {
        for (int i = 0; i < N; i++) {
